...
from .views import mod_delete_content, permission_denied, mod, signup, recover_password, profile, marker_upload, object_upload, create_artwork, create_exhibit, edit_artwork, element_get, edit_exhibit, edit_profile, edit_password, delete
...
urlpatterns = [
    ...
    path('mod-delete-content/', mod_delete_content, name='mod-delete-content'),
]

...
## Get Started
To contribute to ARte it would be awesome if you read [Developers.md](https://github.com/memeLab/ARte/blob/master/Developers.md) and our [Code of conduct](). After a good read you are ready to move foward!
